                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-4">
                        <div class="m-t-20 m-b-20">
                            <h3 class="m-b-10 text-danger"><b>{{ balanceFormat($sum_debit) }}</b></h3>
                            <p class="text-uppercase m-b-5 font-13 font-600">Total Debet</p>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-4">
                        <div class="m-t-20 m-b-20">
                           <h3 class="m-b-10 text-success"><b>{{ balanceFormat($sum_credit) }}</b></h3>
                ...
                <tbody>
                    ...
                    @foreach ($balances as $balance)
                        <tr class="">
                            ...
                            <td><small>{{ $balance->description }}</small></td>
